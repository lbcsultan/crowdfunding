...
import { CROWDFUNDING_FACTORY, PUBLISHER_ADDRESS } from "@/constants/contracts";
...
const CreateCampaignModal = ({
  ...
  const [campaignDurationInDays, setCampaignDurationInDays] =
    useState<number>(1);
  ...
  const handleDeployContract = async () => {
    ...
    try {
      ...
      console.error(error);
      alert("Failed to deploy contract: " + error);
    } finally {
